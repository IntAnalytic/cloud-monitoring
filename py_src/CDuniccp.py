...
def sendfunc(rows5): 
    ...
    df.columns = ['clustername', 'Storage Capacity %', 'Connections % Total', 'CPU Avg %', 'Table %', 'dateentered']
    ...
    plt.plot('dateentered','Storage Capacity %', data=df, marker='o', markerfacecolor='#43BD78', markersize=8, color='#43BD78', linewidth=4)
    ...
    plt.savefig("graph_images/capacity_date_uniccp.png", transparent=False, bbox_inches='tight', pad_inches=0)