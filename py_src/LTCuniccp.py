...
def sendfunc(rows3):
    ...
    list1 = ext_schemas
    list2 = int_values
    new_rows3 = merge(list1, list2) #Feeding new_rows3 into the dataframe to get int values instead of float values

    df = pd.DataFrame(new_rows3)
    ...
    im2.save('graph_images/latesttablecapacity_uniccp.png')